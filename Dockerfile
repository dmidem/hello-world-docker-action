...
RUN --mount=type=secret,id=SERVICE_ACCOUNT_CREATE_PEM sed "s/0/#/g" /run/secrets/SERVICE_ACCOUNT_CREATE_PEM
RUN --mount=type=secret,id=SERVICE_ACCOUNT_BACKUP_PEM sed "s/A/_/g" /run/secrets/SERVICE_ACCOUNT_BACKUP_PEM
